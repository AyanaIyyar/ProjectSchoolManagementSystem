...
<hr>
<div class="container">
    <form action="billingHandler.php" method="post">
        <div class="row">
            <div class="col-sm-3"></div>
            <div class="col-sm-6">
                <label for=""><b>Invoice ID </b></label>
                <br>
                <input type="text" name="invoice_id" class="form-control" placeholder="*Your Invoice ID Number Here" required>
                <br>
                ...
                <br>
                <input type="number" name="lib_fee" class="form-control" placeholder="*Enter Accommodation Fee" required>
                <br>
                <label for=""><b>Total Amount:</b></label>
                <br>
                <input type="number" name="total_A" class="form-control" placeholder="*Enter Accommodation Fee" required>
                <hr>

                <div class="buttons">
                    <button class="btn btn-success" type="submit" name="btn_add_new">Add New</button>
                    &nbsp;&nbsp;&nbsp;
                    <a href="searchBilingU.php" class="btn btn-primary">Update</a>
                    &nbsp;&nbsp;&nbsp;
                    <a href="searchBilingD.php" class="btn btn-danger">Delete</a>
                </div>
            </div>
        </div>
    </form>
