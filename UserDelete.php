...
<div class="container">
    ...
    if ($conn->query($sql)==true){
        print "<p class='text-justify'>User deleted successfully.</p>";
        print "<a href='users.php' class='btn btn-primary'>Delete User</a>";
    }
    else{
        print "<p class='text-justify'>User not deleted.</p>";
