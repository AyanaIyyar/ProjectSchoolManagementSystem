...
$idPassNumber=mysqli_real_escape_string($conn,$_POST['idPass_Number']);
$sql="SELECT * FROM `users` WHERE idPass_number='$idPassNumber'";
...
<hr>
<div class="heading">
    <h3 class="text-center"><b>Update User Details</b></h3>
</div>
<hr>
<div class="container">
    <div class="row">
