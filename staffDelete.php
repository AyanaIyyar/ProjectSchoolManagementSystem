...
<div class="container">
    ...
    $sql="DELETE FROM `staff_table` WHERE idPass_Number='$idPass'";
    //Exceute the query in $sql
    if ($conn->query($sql)==true){
        print "<p class='text-justify'>Staff deleted successfully.</p>";
        print "<a href='staff.php' class='btn btn-primary'>New Person</a>";
    }
    else{
        print "<p class='text-justify'>Staff not deleted.</p>";
