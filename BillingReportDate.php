...
<hr>
<div class="heading">
    <h3 class="text-center"><b>Billing Report</b></h3>
</div>
<hr>
<?php
...
$result=mysqli_query($conn,"SELECT * FROM `billing` WHERE invoice_id>='$DateFrom' &&invoice_id<='$DateTo'");
