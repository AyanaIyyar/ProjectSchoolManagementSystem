...
<div class="container">
    ...
    $sql="DELETE FROM `enquire` WHERE id_Number='$idNumber'";
    //Exceute the query in $sql
    if ($conn->query($sql)==true){
        print "<p class='text-justify'>Enquiries deleted successfully.</p>";
        print "<a href='enquiries.php' class='btn btn-primary'>New Person</a>";
    }
    else{
        print "<p class='text-justify'>Enquiries not deleted.</p>";
