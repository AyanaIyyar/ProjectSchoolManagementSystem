...
$sql="SELECT * FROM `billing` WHERE invoice_id='$invoice'";
...
<head>
    ...
    <title>Update Billing/Invoice</title>
...
<hr>
<div class="heading">
    <h3 class="text-center"><b>Update Billing/Invoice</b></h3>
</div>
<hr>
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-6">
            <form action="billingUpdate.php" method="post">
